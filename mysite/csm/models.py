...
class SumMonthly(models.Model):
    ...
    def __str__(self):
        return "%s %s %s %s %s %s %s %s %s %s %s %s %s" % (self.sum_m_date, self.str_code.str_loc, self.str_code.str_city, self.str_code, 
                                                           self.str_code.str_name, self.prd_code, self.prd_code.prd_name, self.prd_code.prd_barcode, 
